...
const HeroVideo: FC = () => {
  return (
    <div
      className="mt-9 flex items-center justify-center max-w-[756px] w-[calc(100%-32px)] relative mx-4 lg:mx-auto"
      style={{
        aspectRatio: 756 / 425,
      }}
    >
      <div className="">
        <Image
          ...
          layout="fill"
          src="/images/landing-first-section.webp"
          alt=""
        />
      ...
      <div className="w-[1080px] h-[987px] pointer-events-none absolute left-[-440px] top-[-350px] scale-50 lg:scale-100 opacity-55">
        <img src="/images/hero-gradient-2.png" alt="" />
      </div>
      <div className="w-[1080px] h-[987px] pointer-events-none absolute right-[-440px] top-[-350px] scale-50 lg:scale-100 opacity-55">
        <img src="/images/hero-gradient-2.png" alt="" />
      </div>
